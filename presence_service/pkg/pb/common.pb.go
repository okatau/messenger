...
func (x *UserInfo) GetMetadata() []*MapMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *MapMetadata) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *MapMetadata) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
const file_common_proto_rawDesc = "" +
	...
	"\bmetadata\x18\x02 \x03(\v2\f.MapMetadataR\bmetadata\"5\n" +
	"\vMapMetadata\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"A\n" +
	"\x06Status\x12\x1d\n" +
	"\x06status\x18\x01 \x01(\x0e2\x05.CodeR\x06status\x12\x18\n" +
	...
	"\tDATA_LOSS\x10\x0fB\x19Z\x17presence_service/pkg/pbb\x06proto3"
...
var file_common_proto_goTypes = []any{
	...
	(*MapMetadata)(nil), // 2: MapMetadata
	(*Status)(nil),      // 3: Status
}
var file_common_proto_depIdxs = []int32{
	2, // 0: UserInfo.metadata:type_name -> MapMetadata
	0, // 1: Status.status:type_name -> Code
